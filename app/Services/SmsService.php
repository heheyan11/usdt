...
class SmsService
{
    private $AppKey = '257b97fda25648e1bd7a57dfd29a822b';                //开发者平台分配的AppKey
    private $AppSecret = '4b5fd00ca98e';             //开发者平台分配的AppSecret,可刷新
    ...
    //$this->sendSmsCode($phone,'4102536');
     ...
     * 发送短信验证码
     * @param  $mobile [目标手机号]
     * @param  $template [模板id，可选参数]
     * @return $result      [返回array数组对象]
     */
    public function sendSmsCode($mobile, $template = '')
    {
